...
class SFTClusterTrain(SFTCluster):
    def __init__(self, cfg):
        super().__init__(cfg)
        # load sft train dataset
        self.dataset = SFTDatasetTrain(self.sft_data_path)
        self.load_data()
    ...
    def load_data(self):
        self.sample_dataloader = self.create_dataloader(batch_size=self.cfg.dataset.batch_size)
