...
from lavis.datasets.datasets.gqa_datasets import GQADataset

def parse_args():
    parser = argparse.ArgumentParser(description="Demo")
    # parser.add_argument("-f", help="jupyter notebook")
    parser.add_argument("--cfg-path", default="/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/LAVIS/lavis/projects/blip2/train/sft/gqa_sft.yaml", help="path to configuration file.")
...
def create_dataloader(cfg, vis_processors,txt_processors, batch_size=32):
    ann_paths = cfg.config.datasets.gqa.build_info.annotations.train.storage
    vis_root = cfg.config.datasets.gqa.build_info.images.storage
