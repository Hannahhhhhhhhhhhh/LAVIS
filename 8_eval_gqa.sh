...
# lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/LAVIS/8_eval_gqa.sh" -n 1 -j test-blip2-lavis-gqa  -t all -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p default
...
model:
  ...
  pretrained: "/mnt/pfs-guan-ssai/nlu/wanghanzi/experiments/blip2/flant5xxl/sft/gqa_943k_sft_ques_type_prompt_train_qf_train_qt_textinqf_epo3_0925/20230926134/checkpoint_best.pth"
...
datasets:
  gqa: # name of the dataset builder
    type: balanced_testdev_ques_type_prompt
    vis_processor:
        eval:
...
run:
  ...
  seed: 42
  output_dir: "/mnt/pfs-guan-ssai/nlu/wanghanzi/evaluation/BLIP2/GQA/gqa_943k_sft_ques_type_prompt_train_qf_textinf_ckpt3_0925/"
