...
# lizrun start -c "/mnt/pfs-guan-ssai/nlu/wanghanzi/multimodal/LAVIS/1_sft_llava_blip2_single_turn_sft_cluster3.sh" -n 1 -j blip2sft-cluster0-n1-0918  -t all -i reg-ai.chehejia.com/ssai/lizr/cu118/py310/pytorch:2.0.1-multinode-nccl -p default
# PATH_ORI=${0%/*}
...
run:
  ...
  seed: 42
  output_dir: "/mnt/pfs-guan-ssai/nlu/wanghanzi/experiments/blip2/flant5xxl/sft/llava_st_257k_clean_k_means_5_train_cluster_0915/freeze_qf_train_qt_textinqf_epo3_cluster0/"
